...
//	window.location.href="/view/recommend_music"
    ...
    if (lang == "zh"){	
		window.open('/view/recommend_music/?lang='+lang);
	}else{
		window.open('/view/recommend_music/');
	}
}
...
function transform(json_str){
	...
	document.getElementById("music_recommend_form_view").innerHTML = language["language_data"]["Music"]["recommend_form"]["view"]
